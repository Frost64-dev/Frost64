...
#define NAME_CASE(ins, lower_ins) \
    ...
    switch (opcode) {
        ...
        NAME_CASE(JNS, jns)
        NAME_CASE(SETC, setc)
        NAME_CASE(SETNC, setnc)
        NAME_CASE(SETZ, setz)
        NAME_CASE(SETNZ, setnz)
        NAME_CASE(SETL, setl)
        NAME_CASE(SETLE, setle)
        NAME_CASE(SETNL, setnl)
        NAME_CASE(SETNLE, setnle)
        NAME_CASE(SETO, seto)
        NAME_CASE(SETNO, setno)
        NAME_CASE(SETS, sets)
        NAME_CASE(SETNS, setns)
        NAME_CASE(MOVC, movc)
        NAME_CASE(MOVNC, movnc)
        NAME_CASE(MOVZ, movz)
        NAME_CASE(MOVNZ, movnz)
        NAME_CASE(MOVL, movl)
        NAME_CASE(MOVLE, movle)
        NAME_CASE(MOVNL, movnl)
        NAME_CASE(MOVNLE, movnle)
        NAME_CASE(MOVO, movo)
        NAME_CASE(MOVNO, movno)
        NAME_CASE(MOVS, movs)
        NAME_CASE(MOVNS, movns)
        NAME_CASE(MOV, mov)
        NAME_CASE(NOP, nop)
        NAME_CASE(HLT, hlt)
        NAME_CASE(PUSH, push)
